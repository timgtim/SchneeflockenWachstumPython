...
ordnerDateien = 'ProgrammReitersModell/Dateien'
if not os.path.exists(ordnerDateien): #wenn es keinen Ordner mit dem Namen gibt, einen neuen erstellen
    os.makedirs(ordnerDateien)
ordnerDateien = 'ProgrammReitersModell/Dateien/Animationen'
if not os.path.exists(ordnerDateien): #wenn es keinen Ordner mit dem Namen gibt, einen neuen erstellen
    os.makedirs(ordnerDateien)
ordnerDateien = 'ProgrammReitersModell/Dateien/Bilder'
if not os.path.exists(ordnerDateien): #wenn es keinen Ordner mit dem Namen gibt, einen neuen erstellen
    os.makedirs(ordnerDateien)
ordnerDateien = 'ProgrammReitersModell/Dateien/csvDateien'
if not os.path.exists(ordnerDateien): #wenn es keinen Ordner mit dem Namen gibt, einen neuen erstellen
    os.makedirs(ordnerDateien)
